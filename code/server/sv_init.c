...
void SV_Init (void) {
	...
	//sysmyks mod
	mod_enableJumpCmds = Cvar_Get("mod_enableJumpCmds", "1", CVAR_ARCHIVE);
	...
	mod_allowPosSaving = Cvar_Get("mod_allowPosSaving", "1", CVAR_ARCHIVE);
	...
	mod_freeSaving = Cvar_Get("mod_freeSaving", "1", CVAR_ARCHIVE);
